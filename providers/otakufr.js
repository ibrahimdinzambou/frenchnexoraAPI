 ...
 * Generated: 2026-06-24T11:29:53.324593304Z
 */
var __provider = (() => {
  ...
  var PROVIDER_BUDGET_MS, RETRY_DELAYS, HEADERS, _atob, CODEC_PREFERENCE, TV_BUDGET_MS, STRICT_QUALITY_TIERS, DEFAULT_QUALITY_TIER, CODEC_PRIORITY, manifestCache, MANIFEST_CACHE_TTL, FETCH_CACHE_TTL, fetchCache, KNOWN_HOST_NAMES, peeledUrls, AD_IFRAME_PATTERNS, VIDEO_IFRAME_SCORE, BASE_URL_FORBIDDEN_PATTERN;
      ...
      try {
        ...
        if (!iframeUrl) {
          try {
            ...
            console.warn(`[Otakufr] Cheerio iframe extraction failed: ${e == null ? void 0 : e.message}`);
          }
        }
