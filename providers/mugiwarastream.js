 ...
 * Generated: 2026-07-13T18:23:47.766027738Z
 */
var __provider = (() => {
  ...
  function findCachedSlug(titles) {
    return __async(this, null, function* () {
      for (const t of titles) {
        const slug = yield slugCache(`slug_${t.toLowerCase()}`, () => __async(null, null, function* () {
          const found = yield findSlug(titles);
          for (const other of titles) {
            if (other.toLowerCase() !== t.toLowerCase()) {
              yield slugCache(`slug_${other.toLowerCase()}`, () => __async(null, null, function* () {
                return found;
              }));
            }
          }
