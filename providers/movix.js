 ...
 * Generated: 2026-06-29T22:14:39.907279855Z
 */
var __provider = (() => {
  ...
  function pushStream(streams, provider, server, lang, url, quality) {
    ...
    streams.push({
      ...
      headers: { Referer: origin + "/", Origin: origin, "User-Agent": USER_AGENT2 }
    });
  }
  ...
  function resolveForExo(stream) {
    return __async(this, null, function* () {
      ...
      return {
        ...
        isDirect: true,
        headers: __spreadProps(__spreadValues({}, resolved.headers), { "User-Agent": USER_AGENT2 })
      };
    });
  }
  ...
  var API_BASE, USER_AGENT2, SLOW_HOSTS, FAST_HOSTS;
