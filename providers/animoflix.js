 ...
 * Generated: 2026-06-29T22:14:39.563279465Z
 */
var __provider = (() => {
  ...
  function _extractStreams(tmdbId, mediaType, season, episode) {
    return __async(this, null, function* () {
      ...
      const animeDetailHtml = yield anfCached(
        `serie_${slug}`,
      ...
      for (const targetSeason of fallbackSeasons) {
        ...
        const seasonHtml = yield anfCached(
  ...
  var import_cheerio_without_node_native2, BASE_URL, SEARCH_URL, TIMEOUT, SPECIAL_SLUG_RE, MAX_TITLE_SEARCHES, ANF_CACHE_TTL, anfCache;
  var init_extractor = __esm({
    "src/animoflix/extractor.js"() {
      ...
      ANF_CACHE_TTL = 5 * 60 * 1e3;
      anfCache = /* @__PURE__ */ new Map();
    }
  });
